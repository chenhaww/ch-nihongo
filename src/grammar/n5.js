...
export const N5 = [
  {
    ...
    quiz: [
      { q: 'Polite "I am a teacher": 先生＿。', options: ['だ', 'です', 'でした', 'を'], answer: 1,
        explain: 'です is the polite copula.' },
      { q: 'Which is casual?', options: ['です', 'でございます', 'だ', 'ですか'], answer: 2,
  ...
  },
  {
    ...
    quiz: [
      { q: '私＿田中です。', options: ['は', 'を', 'で', 'と'], answer: 0,
  ...
  },
  {
    ...
    quiz: [
      { q: 'Polite form of 食べる:', options: ['食べるます', '食べます', '食べります', '食べました'], answer: 1,
        explain: 'Stem 食べ + ます.' },
  ...
  },
  {
    ...
    quiz: [
      { q: '水＿飲みます。', options: ['を', 'は', 'に', 'へ'], answer: 0,
  ...
  },
  {
    ...
    quiz: [
      { q: '学校＿行きます。', options: ['を', 'に', 'が', 'も'], answer: 1,
  ...
  },
  {
    ...
    quiz: [
      { q: 'レストラン＿食べます。', options: ['に', 'で', 'を', 'へ'], answer: 1,
        explain: 'Eating is an action, so the location takes で.' },
      { q: '箸＿食べます (eat WITH chopsticks):', options: ['で', 'に', 'を', 'と'], answer: 0,
  ...
  },
  {
    ...
    quiz: [
      { q: 'Negative of 高い (expensive):', options: ['高いない', '高くない', '高じゃない', '高くじゃ'], answer: 1,
        explain: 'Drop い, add くない.' },
      { q: 'Past of 楽しい:', options: ['楽しいだった', '楽しかった', '楽しくた', '楽しいでした'], answer: 1,
  ...
  },
  {
    ...
    quiz: [
      { q: '_ 部屋 (a quiet room): 静か＿部屋', options: ['い', 'な', 'だ', 'の'], answer: 1,
        explain: 'な-adjectives take な before a noun.' },
      { q: 'Negative of 元気 (polite):', options: ['元気くない', '元気じゃありません', '元気ない', '元気かった'], answer: 1,
  ...
  },
  {
    ...
    quiz: [
      { q: 'Polite negative of 行きます:', options: ['行きません', '行かない', '行きないです', '行きませんだ'], answer: 0,
        explain: 'ます → ません.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'Polite past of 食べます:', options: ['食べました', '食べた', '食べでした', '食べますた'], answer: 0,
        explain: 'ます → ました.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'て-form of 飲む:', options: ['飲みて', '飲んで', '飲むて', '飲いて'], answer: 1,
        explain: 'む/ぶ/ぬ verbs → んで.' },
      { q: 'Polite request "please wait": 待っ＿', options: ['てください', 'てだ', 'てます', 'てない'], answer: 0,
  ...
  },
  {
    ...
    quiz: [
      { q: '"I want to eat": 食べ＿', options: ['たい', 'たいだ', 'ほしい', 'まい'], answer: 0,
        explain: 'stem 食べ + たい.' },
      { q: 'Negative of 行きたい:', options: ['行きたいない', '行きたくない', '行きたくじゃ', '行きないたい'], answer: 1,
  ...
  },
  {
    ...
    quiz: [
      { q: '"Because it\'s expensive, I won\'t buy it": 高い＿、買いません。', options: ['から', 'まで', 'より', 'のに'], answer: 0,
  ...
  },
  {
    ...
    quiz: [
      { q: '猫が＿。', options: ['あります', 'います', 'です', 'します'], answer: 1,
        explain: 'A cat is animate → います.' },
      { q: '机の上に本が＿。', options: ['います', 'あります', 'です', 'いります'], answer: 1,
